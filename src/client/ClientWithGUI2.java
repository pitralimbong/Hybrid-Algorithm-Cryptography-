...
public class ClientWithGUI2 extends javax.swing.JFrame 
{
    ...
    double convert;
    BigInteger p, q, n, e, d, pEl, g,u_a,k;
    BigInteger a, a_inv, b,kurang,v,v_e;
    BigInteger x2, y2;
    String cipher = "";
    String cipher2 = "";
    String plain = "";
    ...
    BigInteger el_pel,el_x,rsa_d,rsa_n,el_a,rsa_a,rsa_u,rsa_phi,rsa_e;//dekripsi
        
    public ClientWithGUI2(double convert, BigInteger p, BigInteger q, BigInteger n, BigInteger e, BigInteger d, BigInteger u_a, BigInteger y, BigInteger pEl, BigInteger x, BigInteger g) {
        initComponents();
    ...
    public BigInteger getU_a() {
        return u_a;
    }

    public void setU_a(BigInteger u_a) {
        this.u_a = u_a;
    }
    ...
    public BigInteger getRsa_a() {
        return rsa_a;
    }

    public void setRsa_a(BigInteger rsa_a) {
        this.rsa_a = rsa_a;
    }

    public BigInteger getRsa_u() {
        return rsa_u;
    }

    public BigInteger getRsa_e() {
        return rsa_e;
    }

    public void setRsa_e(BigInteger rsa_e) {
        this.rsa_e = rsa_e;
    }

    public void setRsa_u(BigInteger rsa_u) {
        this.rsa_u = rsa_u;
    }

    public BigInteger getRsa_phi() {
        return rsa_phi;
    }

    public void setRsa_phi(BigInteger rsa_phi) {
        this.rsa_phi = rsa_phi;
    }
   ...
   public void enkripsi(String plaintext){
       ...
       for (int i = 0; i < plaintext.length(); i++) {
           ...
           BigInteger Q = b.multiply(getU_a());
           BigInteger C = Q.modPow(getE(), getN());
           cipher = cipher + C + " ";
       }
   ...
   public void dekripsi(String ciphertext){
        ...
        BigInteger modulo  = new BigInteger(panjang_bit2, new Random());
        long start = System.nanoTime();
        kurang = getRsa_phi().subtract(getRsa_a());
        System.out.println("phi-a :" + kurang);
        v = getRsa_u().modPow(kurang, getRsa_n());
        System.out.println("nilai v :" + v);
        v_e = v.modPow(getRsa_e(), modulo);
        ...
        for (int i = 1; i < data_cipher.length; i++) {
            ...
            BigInteger mes = X.modPow(getRsa_d(), getRsa_n());
            BigInteger M = mes.multiply(a_inv).mod(getEl_pel()); 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("Nilai g : " + getU_a());
        ...
        this.setRsa_n(rsa_n);
        rsa_u  = new BigInteger(JOptionPane.showInputDialog("Enter Value of U :"));
        this.setRsa_u(rsa_u);
        rsa_a  = new BigInteger(JOptionPane.showInputDialog("Enter Value of A :"));
        this.setRsa_a(rsa_a);
        rsa_phi  = new BigInteger(JOptionPane.showInputDialog("Enter Value of phi :"));
        this.setRsa_phi(rsa_phi);
        rsa_e  = new BigInteger(JOptionPane.showInputDialog("Enter Value of e :"));
        this.setRsa_e(rsa_e);
        }else{
